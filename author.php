        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card-footer text-muted">
                    ...
                    <h3><?php echo $view_user_name; ?></h3> Веб-разработчик <a href="#"> <i class="bi bi-gem"></i> RubyMain </a> <br>
                    <a href=""> <i class="fas fa-envelope"></i></a>&nbsp;&nbsp;<a href=""><i class="fab fa-facebook"></i></a>
                </div>

                <div class="card-footer text-muted"> Я профессионально писал о технологиях всю свою взрослую профессиональную жизнь — около 10 лет. Я стремлюсь понять, как работают сложные технологии, и объяснить их доступным для всех способом. </div>

                <h3 class="my-4">The Latest from<?php echo $view_user_name; ?> <!-- <small> Вторичный текст </small>--> </h3>
                <?php
                ...
                <?php
                   ...
                   if ($post_counter_for_category==0) {
                     echo "<h1> Извините. Нет сообщений от этого пользователя! </h1>";
                   }
                ?>
                <!-- Pagination -->
                <ul class="pagination justify-content-center mb-4">
                    <li class="page-item">
                        <a class="page-link" href="#">&larr; Старший</a>
                    </li>
