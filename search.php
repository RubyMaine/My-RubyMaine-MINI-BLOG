...
<body>
    ...
    <div class="container">
        <div class="row">
            <!-- Blog Entries Column -->
            <div class="col-md-8">
                <h1 class="my-4"> Результаты поиска: <small></small> </h1>
                <?php
                    $no_posts_per_page = 5;
                    if (isset($_GET['page'])){
                            $page = $_GET['page'];
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="post.php?postid=<?= $view_post_id; ?>" class="btn btn-primary">Читать далее &rarr;</a>
                    </div>
                    <?php
                    ...
                    <div class="card-footer text-muted">
                        ...
                        От <a href="#"><?php echo $view_users_name; ?></a> <br> Веб-разработчик <a href="#"> RubyMaine </a>
                    ...
                    <li class="page-item">
                        <?php
                            ...
                            if($page > 1)
                            {
                              $previous= $page - 1;
                        ?>
                        <a class="page-link" href="search.php?page=<?php echo $previous ?>&search=<?php echo $search_text ?>">&larr; Предыдущий</a>
                        <?php } ?>
                    </li>
                    <li class="page-item">
                        <?php
                            if ($page < $allpages)
                                ...
                                $next= $page + 1;
                        ?>
                        <a class="page-link" href="search.php?page=<?php echo $next ?>&search=<?php echo $search_text ?>">Следующий &rarr;</a>
                        <?php } ?>
                    </li>
                </ul>
            </div>
