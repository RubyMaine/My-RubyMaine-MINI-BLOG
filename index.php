            ...
            <!-- Blog Post -->
                <div class="card mb-4">
                    ...
                    <div class="card-footer text-muted">
                        ...
                        От <a href="author.php?auth=<?= $view_users_id; ?>"><?php echo $view_users_name; ?></a> <br> Веб-разработчик <a href="#"> RubyMaine </a>
                ...
                <ul class="pagination justify-content-center mb-4">
                    <li class="page-item">
                        ...
                        if($page > 1)
                        {
                          $previous= $page - 1;
                        ?>
                        <a class="page-link" href="index.php?page=<?php echo $previous ?>">&loarr; Предыдущий</a>
                        <?php } ?>
                    </li>
                    <li class="page-item">
                        <?php
                            if ($page < $allpages)
                            {
                                $next= $page + 1;
                        ?>
                        <a class="page-link" href="index.php?page=<?php echo $next ?>">Следующий &roarr;</a>
                        <?php } ?>
                    </li>
                </ul>
            </div>
