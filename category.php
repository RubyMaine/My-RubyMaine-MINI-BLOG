                ...
                <div class="card mb-4">
                    ...
                    <?php
                           ...
                           if ($post_counter_for_category==0) {
                             echo "<h1> Извините. В этой категории нет сообщений! </h1>";
                           }
                        ?>
                    <!-- Pagination -->
                        ...
                        <?php
                            ...
                            $allpages = ceil($sum_posts / $no_posts_per_page);
                                if($page > 1)
                                {
                                  $previous= $page - 1;
                                ?>
                            <a class="page-link" href="category.php?catid=<?= $view_category_id; ?>&page=<?php echo $previous ?>">&larr; Предыдущий</a>
                            <?php } ?>
                        </li>
                        <li class="page-item">
                        <?php
                            if ($page < $allpages)
                                ...
                                $next= $page + 1;
                            ?>
                        <a class="page-link" href="category.php?catid=<?= $view_category_id; ?>&page=<?php echo $next ?>">Следующий &rarr;</a>
                        <?php } ?>
                      </li>
                    </ul>
                </div>
