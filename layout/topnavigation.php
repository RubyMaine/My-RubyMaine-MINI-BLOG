<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php" style="padding-top: 0px;"><img src="images/RubyMain_Mini_BLOG.png" style="width: 300px;" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="index.php"><i class="bi bi-house-fill"></i> Главная <span class="sr-only">(current)</span></a>
                </li>
                <?php
